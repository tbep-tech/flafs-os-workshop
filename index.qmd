...
Please attend the workshop with a personal laptop and power supply. Make sure your laptop can access publicly available WiFi. *You will also need to install software prior to the workshop, visit the [setup](#setup) page for full instructions*.  We will have limited capacity to help with installation issues the day of the workshop, so please come prepared.  The [setup](#setup) instructions will guide you through the following.
